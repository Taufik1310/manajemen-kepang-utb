...
<h2 class="text-3xl font-bold mb-4">Data Kegiatan</h2>
...
<div class="bg-white relative shadow-md rounded w-full overflow-hidden">
    <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4">
        ...
        <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-3">
            <a href="<?= BASE_URL ?>app/views/kegiatan/tambah.php"
            ...
            <a href="<?= BASE_URL ?>app/controllers/KegiatanController.php?export=pdf" target="_blank"
            ...
            <tbody>
                <?php while ($row = $data->fetch_assoc()): ?>
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-3 font-medium text-gray-900"><?= $row['nama_kegiatan'] ?></td>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex space-x-2">
                                <a href="<?= BASE_URL ?>app/views/kegiatan/edit.php?id=<?= $row['id'] ?>"
                                ...
                                <a href="<?= BASE_URL ?>app/controllers/KegiatanController.php?hapus=<?= $row['id'] ?>"
