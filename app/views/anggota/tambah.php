...
<h3 class="text-2xl font-bold mb-4">Tambah Data Anggota</h3>
...
<form action="<?= BASE_URL ?>app/controllers/AnggotaController.php" method="POST" class="bg-white text-gray-500 w-full p-6 text-left text-sm rounded border border-gray-300/60">
    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
            ...
            <input name="nama" id="nama" class="w-full border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 px-3" type="text" placeholder="Masukkan nama" required>
        </div>
        <div>
            <label class="font-medium" for="nim">NIM</label>
            <input name="nim" id="nim" class="w-full border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 px-3" type="text" placeholder="Masukkan nim" required>
        </div>
        <div>
            <label class="font-medium" for="jurusan">Jurusan</label>
            <input name="jurusan" id="jurusan" class="w-full border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 px-3" type="text" placeholder="Masukkan jurusan" required>
        </div>
        <div>
            <label class="font-medium" for="angkatan">Angkatan</label>
            <input name="angkatan" id="angkatan" class="w-full border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 px-3" type="number" placeholder="Masukkan angkatan" required>
        </div>
        <div>
    ...
    <div class="flex items-center justify-start space-x-4">
        <button type="submit" name="simpan" class="my-3 bg-amber-900 py-2 px-5 rounded text-white font-medium cursor-pointer">Simpan</button>
