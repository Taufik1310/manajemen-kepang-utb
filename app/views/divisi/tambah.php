...
<h3 class="text-2xl font-bold mb-4">Tambah Data Divisi</h3>
...
<form action="<?= BASE_URL ?>app/controllers/DivisiController.php" method="POST" class="bg-white text-gray-500 w-full p-6 text-left text-sm rounded border border-gray-300/60">
    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
            ...
            <input name="nama_divisi" id="nama_divisi" class="w-full border mt-1.5 border-gray-500/30 outline-none rounded py-2.5 px-3" type="text" placeholder="Masukkan nama divisi" required>
        </div>
    </div>
