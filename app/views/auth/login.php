        ...
        <div class="lg:w-5/12 w-full flex flex-col items-center justify-center">
            <form action="<?= BASE_URL ?>app/controllers/AuthController.php" method="POST" class="md:w-96 w-80 flex flex-col items-center justify-center">
                ...
                <div class="flex items-center gap-4 w-full my-5">
                    ...
                    <p class="w-full text-nowrap text-sm text-gray-500/90">atau masuk dengan username</p>
                    <div class="w-full h-px bg-gray-300/90"></div>
                </div>
                ...
                <button type="submit" name="login" class="mt-8 w-full h-11 rounded-full text-white bg-amber-900 hover:opacity-90 transition-opacity">
                    Login
                </button>
                <p class="text-gray-500/90 text-sm mt-4">Belum punya akun? <a class="text-amber-900 hover:underline" href="#">Daftar</a></p>
            </form>
        </div>
    </div>
</body>
